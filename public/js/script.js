	...
	<div class="col-lg-9">
		<div class="card">
			...
			<div class="card-body">
				...
				<div class="table-responsive mt-2">${{raw:function(t){if(!t)return"";let e='<table class="table mb-0 table-bordered">';for(let s=0;s<t.length;s++){0==s&&(e+='<thead class="thead-light">');let a=t[s],n=0==s?"th":"td";e+="<tr>";for(let t=0;t<a.length;t++)e+=`<${n}>${escapeHtml(a[t])}</${n}>`;e+="</tr>",0==s&&(e+="</thead>")}return e+="</table>"}(v)}}</div>
			</div>
		</div>
	</div>
	<div class="col-lg-3">
