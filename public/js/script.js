...
<div class="row">
	...
	`),c=o.find('[name="words"]');c[0].setSelectionRange(0,c.text().length),c.focus(),c.keydown(function(t){if(9==t.keyCode){t.preventDefault();var e=this.selectionStart,s=this.selectionEnd;this.value=this.value.substr(0,e)+"\t"+this.value.substr(s),this.setSelectionRange(e+1,e+1)}}),i||o.find('[name="control-overwrite"]').hide();let r=new d;r.assign({form:o.find("form"),fields:{title:{required:!0},words:{required:!0}},validate:function(t){o.find('[name="words"]').val();return!!(new k).parse(e,r)&&(!!window.app.cookies.get("auth")||(y(),!1))},callback:function(t){t.table_path&&window.app.goto({url:t.table_path,cb:!0,post:!0})},confirmMessage:"save?"}),o.find('[name="btn-test"]').click(t=>{t.preventDefault(),t.stopPropagation();let e=o.find('[name="title"]').val(),s=o.find('[name="words"]').val(),a=(new k).parse(s,r);a&&S({title:e,list:a})}),window.app.account&&window.app.account.dir&&window.app.readJson(window.app.account.dir,function(t){if(t.categories){let e="";for(let s in t.categories){let a=t.categories[s].name;e+=`<a class="dropdown-item" href="javascript:void(0);" onclick="$(this).parent().parent().parent().find('input').val('${a}');">${a}</a>`}e&&o.find('[name="category"]').parent().append(`\n<div class="input-group-append">\n\t<button data-toggle="dropdown" type="button" class="btn btn-secondary dropdown-toggle"></button>\n\t<div class="dropdown-menu dropdown-menu-right">${e}</div>\n</div>\n\t\t\t\t\t`)}})},C=function({list:t,userId:e=0}){let s="";if(!t)return s;for(let a in t){let n=t[a],i="";n.description&&(i+=`<div class="text-muted">${n.description}</div>`),!e&&n.user_url&&(i+=`\n<div class="d-flex align-items-center${n.description?" pt-5":""}">\n\t<div class="avatar avatar-sm mr-2"><i class="fe fe-user"></i></div>\n\t<div>\n\t\t<a href="${n.user_url}" class="text-default">${n.user_name}</a>\n\t</div>\n</div>\n\t\t\t`),i&&(i=`<div class="card-body d-flex flex-column">${i}</div>`),s+=`\n<div class="col-md-6 col-lg-4">\n\t<div class="card">\n\t\t<div class="card-header">\n\t\t\t<h3 class="card-title"><a href="${n.url}">${n.name}</a></h3>\n\t\t</div>\n\t\t${i}\n\t</div>\n</div>\n\t\t`}return s};function J(t){let e=[];for(let s in t){let a=t[s];a.id=parseInt(a.id),e.push(a)}return e.sort(function(t,e){return t.id>e.id?-1:t.id<e.id?1:0}),e}function R(t,e){let s="",a=e[t.id];if(a){for(let t in a)s+=R(a[t],e);s=`<div class="card-body d-flex flex-column">${s}</div>`}return`\n\t<div class="card">\n\t\t<div class="card-header">\n\t\t\t<h3 class="card-title"><a href="${t.url}">${t.name}</a></h3>\n\t\t</div>\n\t\t${s}\n\t</div>\n\t`}var U=function(){let t=$("#main-container"),e=t.find('[name="user_id"]').val(),s=t.find(".user").text(),a=t.find(".user").attr("href"),n=t.find('[name="category_id"]').val(),i=t.find(".category").text(),l=t.find(".category").attr("href"),o=t.find('[name="table_id"]').val(),r=parseInt(t.find('[name="private"]').val()),d=t.find(".title").text(),p=t.find(".description").text(),u=t.find(".words").text(),m=encodeURIComponent(document.URL),f=e==window.app.account.id,g=(new k).parse(u);t=c(escapeTemplate`
<div class="row">
	<div class="col-lg-9">
		<div class="card">
			<div class="card-header">
